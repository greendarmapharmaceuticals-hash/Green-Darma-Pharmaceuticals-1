    ...
    public function run(): void
    {
        ...
        $products = [
            ...
            [
                ...
                'meta_description' => 'SCABICOD SOAP (Permethrin 1% w/w) for effective scabies treatment, mite eradication & rapid itch relief. DGDA certified medicated soap bar in Bangladesh.',
                'meta_keywords' => 'SCABICOD SOAP, Scabicod Soap, Permethrin 1% soap, anti scabies soap, scabies treatment soap bar, mite soap, skabicod, scabicode, scabies sabun, scabicide soap, Green Darma Scabicod, scabies skin soap, Permethrin soap price in Bangladesh, scabies soap BD, skabicod soap, scabicodsoap, permethrin soap, 1% permethrin soap, scabies home treatment soap, anti-itch soap bar Bangladesh',
                'search_aliases' => 'scabicod soap, skabicod soap, scabicode soap, skabicod, scabicode, scabicod, scabicodsoap, skabicodsoap, scabies soap, soap scabies, permethrin 1% soap, permethrin soap bar, anti mite soap, mite soap, scabies sabun, scabies treatment soap, itching soap bar, permethrin soap price in bangladesh, scabies skin bar, skabikod, scabikod, scabicide soap bar, scabies patient soap, স্ক্যাবিকড সোপ, খোসপাঁচড়া সাবান, উকুনের সাবান, স্ক্যাবিস সোপ, পারমেথ্রিন সোপ',
                'image_alt' => 'SCABICOD SOAP Permethrin 1 percent Anti-Scabies Medicated Soap Bar 75g Packaging Green Darma Pharmaceuticals',
                'status' => 'published',
                'is_featured' => true,
                'faqs' => [
                    ...
                    ['question' => 'Can SCABICOD SOAP be used alongside SCABVAR Lotion?', 'answer' => 'Yes! SCABICOD SOAP serves as an ideal daily hygienic cleansing soap bar during or after SCABVAR Lotion (Permethrin 5% + Crotamiton 10%) therapy.'],
                ],
            ],
            ...
            [
                ...
                'meta_keywords' => 'Tinea Soap, Tinea Soap Luliconazole, Luliconazole 1% soap, topical antifungal soap bar, tinea corporis soap, tinea cruris soap, tinea pedis soap, ringworm soap, athlete\'s foot soap, jock itch soap, tenia soap, tinia soap, dadu soap, Green Darma Luliconazole, tineasoap, teniasoap, antifungal soap Bangladesh, dadu khujli soap',
                'search_aliases' => 'tinea soap, tenia soap, tinia soap, tineasoap, teniasoap, tiniasoap, tineasop, tina soap, luliconazole soap, luliconazole 1% soap bar, ringworm soap, athlete\'s foot soap, jock itch soap, antifungal soap, dadu soap, khujli soap, tinea cruris soap, tinea corporis soap, tinea pedis soap, luliconazole soap bangladesh, fungal infection soap bar, luliconazole 1 percent soap, soap for ringworm, soap for fungal itch, টিনিয়া সোপ, দাউদ সাবান, ছত্রাক সাবান, চুলকানি সাবান, লুলিকোনাজল সোপ',
                'image_alt' => 'Tinea Soap Luliconazole 1 percent Topical Antifungal Medicated Soap Bar 75g Packaging Green Darma Pharmaceuticals',
                'status' => 'published',
                'is_featured' => true,
                'faqs' => [
            ...
            [
                ...
                'seo_title' => 'SCABVAR Lotion (Permethrin 5% + Crotamiton 10%) - Scabicide & Anti-Itch Lotion | Green Darma',
                'meta_description' => 'SCABVAR Lotion (Permethrin 5% + Crotamiton 10%) for complete scabies eradication & fast itch relief. Dual-action topical scabicide & antipruritic lotion in Bangladesh.',
                'meta_keywords' => 'SCABVAR Lotion, SCABVAR, Permethrin 5% Crotamiton 10% lotion, scabies lotion, antipruritic lotion, scabicide lotion, scabvar, scab var, scabvac, anti itch lotion, permethrin lotion Bangladesh, Green Darma SCABVAR, scabvarlotion, skabvar, scabver, scabies treatment lotion BD',
                'search_aliases' => 'scabvar lotion, scabvar, scab var, scabvac, scabvarlotion, skabvar, scabver, skabvar lotion, scabbar lotion, scab bar, permethrin 5% lotion, crotamiton 10% lotion, permethrin crotamiton lotion, scabies lotion, scabicide lotion, anti itch lotion, scabies treatment lotion, anti-itch lotion bangladesh, permethrin lotion price in bd, scabies lotion 60ml, antipruritic lotion for eczema, scabies infection lotion, স্ক্যাবভার লোশন, স্ক্যাবিস লোশন, চুলকানির লোশন, পারমেথ্রিন লোশন',
                'image_alt' => 'SCABVAR Lotion Permethrin 5 percent Crotamiton 10 percent Dual Action Scabicide and Antipruritic Lotion 60ml Bottle Green Darma',
                'status' => 'published',
                'is_featured' => true,
                'faqs' => [
                    ...
                    ['question' => 'Should I use SCABICOD SOAP while using SCABVAR Lotion?', 'answer' => 'Yes, SCABICOD SOAP can be used during daily bathing to maintain skin hygiene and assist in clearing scabies mites.'],
                ],
            ],
